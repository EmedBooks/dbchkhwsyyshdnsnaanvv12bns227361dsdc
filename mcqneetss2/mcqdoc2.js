...
var qstHead;
var groups;
var quizTitle="MCQ - Approach to rheumatic diseases";
var printCpRg=1;
var filename = 'mcqdoc2';
...
function completeInitValuate() {
 if (frames.quiz_main.currPage==0) {
   if (valid[0]==0) {
     ...
     StoreAnswer(0);    }
   frames.quiz_main.location.href="mcqdoc2Q2.htm" }
 if (frames.quiz_main.currPage==1) {
   if (valid[1]==0) {
     ...
     StoreAnswer(1);    }
   frames.quiz_main.location.href="mcqdoc2Q3.htm" }
 if (frames.quiz_main.currPage==2) {
   if (valid[2]==0) {
     ...
     StoreAnswer(2);    }
   frames.quiz_main.location.href="mcqdoc2Q4.htm" }
 if (frames.quiz_main.currPage==3) {
   if (valid[3]==0) {
     ...
     StoreAnswer(3);    }
   frames.quiz_main.location.href="mcqdoc2Q5.htm" }
 if (frames.quiz_main.currPage==4) {
   if (valid[4]==0) {
     ...
     StoreAnswer(4);    }
   frames.quiz_main.location.href="mcqdoc2Q6.htm" }
 if (frames.quiz_main.currPage==5) {
   if (valid[5]==0) {
     ...
     StoreAnswer(5);    }
   frames.quiz_main.location.href="mcqdoc2Q7.htm" }
 if (frames.quiz_main.currPage==6) {
   if (valid[6]==0) {
     ...
     StoreAnswer(6);    }
   frames.quiz_main.location.href="mcqdoc2Q8.htm" }
 if (frames.quiz_main.currPage==7) {
   if (valid[7]==0) {
     ...
     StoreAnswer(7);    }
   frames.quiz_main.location.href="mcqdoc2Q9.htm" }
 if (frames.quiz_main.currPage==8) {
   if (valid[8]==0) {
     ...
     StoreAnswer(8);    }
   frames.quiz_main.location.href="mcqdoc2Q10.htm" }
 if (frames.quiz_main.currPage==9) {
   if (valid[9]==0) {
     ...
     StoreAnswer(9);    }
   frames.quiz_main.location.href="mcqdoc2Q11.htm" }
 if (frames.quiz_main.currPage==10) {
   if (valid[10]==0) {
     ...
     StoreAnswer(10);    }
   frames.quiz_main.location.href="mcqdoc2Q12.htm" }
 if (frames.quiz_main.currPage==11) {
   if (valid[11]==0) {
     ...
     StoreAnswer(11);    }
   frames.quiz_main.location.href="mcqdoc2Q13.htm" }
 if (frames.quiz_main.currPage==12) {
   if (valid[12]==0) {
     ...
     StoreAnswer(12);    }
   frames.quiz_main.location.href="mcqdoc2Q14.htm" }
 if (frames.quiz_main.currPage==13) {
   if (valid[13]==0) {
     ...
     StoreAnswer(13);    }
   frames.quiz_main.location.href="mcqdoc2Q15.htm" }
 if (frames.quiz_main.currPage==14) {
   if (valid[14]==0) {
     ...
     StoreAnswer(14);    }
   frames.quiz_main.location.href="mcqdoc2Q16.htm" }
 if (frames.quiz_main.currPage==15) {
   if (valid[15]==0) {
     ...
     StoreAnswer(15);    }
   frames.quiz_main.location.href="mcqdoc2Q17.htm" }
 if (frames.quiz_main.currPage==16) {
   if (valid[16]==0) {
     ...
     StoreAnswer(16);    }
   frames.quiz_main.location.href="mcqdoc2Q18.htm" }
 if (frames.quiz_main.currPage==17) {
   if (valid[17]==0) {
     ...
     StoreAnswer(17);    }
   frames.quiz_main.location.href="mcqdoc2Q19.htm" }
 if (frames.quiz_main.currPage==18) {
   if (valid[18]==0) {
     ...
     StoreAnswer(18);    }
   frames.quiz_main.location.href="mcqdoc2Q20.htm" }
 if (frames.quiz_main.currPage==19) {
   if (valid[19]==0) {
     ...
     StoreAnswer(19);    }
   frames.quiz_main.location.href="mcqdoc2Q21.htm" }
 if (frames.quiz_main.currPage==20) {
   if (valid[20]==0) {
     ...
     StoreAnswer(20);    }
   frames.quiz_main.location.href="mcqdoc2Q22.htm" }
 if (frames.quiz_main.currPage==21) {
   if (valid[21]==0) {
     ...
     StoreAnswer(21);    }
   frames.quiz_main.location.href="mcqdoc2Q23.htm" }
 if (frames.quiz_main.currPage==22) {
   if (valid[22]==0) {
     ...
     StoreAnswer(22);    }
   frames.quiz_main.location.href="mcqdoc2Q24.htm" }
 if (frames.quiz_main.currPage==23) {
   if (valid[23]==0) {
     ...
     StoreAnswer(23);    }
   frames.quiz_main.location.href="mcqdoc2Q25.htm" }
 if (frames.quiz_main.currPage==24) {
   if (valid[24]==0) {
     ...
     StoreAnswer(24);    }
   frames.quiz_main.location.href="mcqdoc2Q26.htm" }
 if (frames.quiz_main.currPage==25) {
   if (valid[25]==0) {
     ...
     StoreAnswer(25);    }
   frames.quiz_main.location.href="mcqdoc2Q27.htm" }
 if (frames.quiz_main.currPage==26) {
   if (valid[26]==0) {
     ...
     StoreAnswer(26);    }
   frames.quiz_main.location.href="mcqdoc2Q28.htm" }
 if (frames.quiz_main.currPage==27) {
   if (valid[27]==0) {
     ...
     StoreAnswer(27);    }
   frames.quiz_main.location.href="mcqdoc2Q29.htm" }
 if (frames.quiz_main.currPage==28) {
   if (valid[28]==0) {
     ...
     StoreAnswer(28);    }
   frames.quiz_main.location.href="mcqdoc2Q30.htm" }
 if (frames.quiz_main.currPage==29) {
   if (valid[29]==0) {
     ...
     StoreAnswer(29);    }
   frames.quiz_main.location.href="mcqdoc2Q31.htm" }
 if (frames.quiz_main.currPage==30) {
   if (valid[30]==0) {
     ...
     StoreAnswer(30);    }
   frames.quiz_main.location.href="mcqdoc2Q32.htm" }
 if (frames.quiz_main.currPage==31) {
   if (valid[31]==0) {
     ...
     StoreAnswer(31);    }
   frames.quiz_main.location.href="mcqdoc2Q33.htm" }
 if (frames.quiz_main.currPage==32) {
   if (valid[32]==0) {
     ...
     StoreAnswer(32);    }
   frames.quiz_main.location.href="mcqdoc2Q34.htm" }
 if (frames.quiz_main.currPage==33) {
   if (valid[33]==0) {
     ...
     StoreAnswer(33);    }
   frames.quiz_main.location.href="mcqdoc2Q35.htm" }
 if (frames.quiz_main.currPage==34) {
   if (valid[34]==0) {
     ...
     StoreAnswer(34);    }
   frames.quiz_main.location.href="mcqdoc2Q36.htm" }
 if (frames.quiz_main.currPage==35) {
   if (valid[35]==0) {
     ...
     StoreAnswer(35);    }
   frames.quiz_main.location.href="mcqdoc2Q37.htm" }
 if (frames.quiz_main.currPage==36) {
   if (valid[36]==0) {
     ...
     StoreAnswer(36);    }
   frames.quiz_main.location.href="mcqdoc2Q38.htm" }
 if (frames.quiz_main.currPage==37) {
   if (valid[37]==0) {
     ...
     StoreAnswer(37);    }
   frames.quiz_main.location.href="mcqdoc2Q39.htm" }
 if (frames.quiz_main.currPage==38) {
   if (valid[38]==0) {
     ...
     StoreAnswer(38);    }
   frames.quiz_main.location.href="mcqdoc2Q40.htm" }
 if (frames.quiz_main.currPage==39) {
   if (valid[39]==0) {
     ...
     StoreAnswer(39);    }
   frames.quiz_main.location.href="mcqdoc2Q41.htm" }
 if (frames.quiz_main.currPage==40) {
   if (valid[40]==0) {
     ...
     StoreAnswer(40);    }
   frames.quiz_main.location.href="mcqdoc2Q42.htm" }
 if (frames.quiz_main.currPage==41) {
   if (valid[41]==0) {
     ...
     StoreAnswer(41);    }
   frames.quiz_main.location.href="mcqdoc2Q43.htm" }
 if (frames.quiz_main.currPage==42) {
   if (valid[42]==0) {
     ...
     StoreAnswer(42);    }
   frames.quiz_main.location.href="mcqdoc2Q44.htm" }
 if (frames.quiz_main.currPage==43) {
   if (valid[43]==0) {
     ...
     StoreAnswer(43);    }
   frames.quiz_main.location.href="mcqdoc2Q45.htm" }
 if (frames.quiz_main.currPage==44) {
   if (valid[44]==0) {
     ...
     StoreAnswer(44);    }
   frames.quiz_main.location.href="mcqdoc2Q46.htm" }
 if (frames.quiz_main.currPage==45) {
   if (valid[45]==0) {
     ...
     StoreAnswer(45);    }
   frames.quiz_main.location.href="mcqdoc2Q47.htm" }
 if (frames.quiz_main.currPage==46) {
   if (valid[46]==0) {
     ...
     StoreAnswer(46);    }
   frames.quiz_main.location.href="mcqdoc2Q48.htm" }
 if (frames.quiz_main.currPage==47) {
   if (valid[47]==0) {
     ...
     StoreAnswer(47);    }
   frames.quiz_main.location.href="mcqdoc2Q49.htm" }
 if (frames.quiz_main.currPage==48) {
   if (valid[48]==0) {
     ...
     StoreAnswer(48);    }
   frames.quiz_main.location.href="mcqdoc2Q50.htm" }
 if (frames.quiz_main.currPage==49) {
   if (valid[49]==0) {
     ...
     StoreAnswer(49);    }
   frames.quiz_main.location.href="mcqdoc2Q51.htm" }
 if (frames.quiz_main.currPage==50) {
   if (valid[50]==0) {
     ...
     StoreAnswer(50);    }
   frames.quiz_main.location.href="mcqdoc2Q52.htm" }
 if (frames.quiz_main.currPage==51) {
   if (valid[51]==0) {
     ...
     StoreAnswer(51);    }
   frames.quiz_main.location.href="mcqdoc2Q53.htm" }
 if (frames.quiz_main.currPage==52) {
   if (valid[52]==0) {
     ...
     StoreAnswer(52);    }
   frames.quiz_main.location.href="mcqdoc2Q54.htm" }
 if (frames.quiz_main.currPage==53) {
   if (valid[53]==0) {
     ...
     StoreAnswer(53);    }
   frames.quiz_main.location.href="mcqdoc2Q55.htm" }
 if (frames.quiz_main.currPage==54) {
   if (valid[54]==0) {
     ...
     StoreAnswer(54);    }
   frames.quiz_main.location.href="mcqdoc2Q56.htm" }
 if (frames.quiz_main.currPage==55) {
   if (valid[55]==0) {
     ...
     StoreAnswer(55);    }
   frames.quiz_main.location.href="mcqdoc2Q57.htm" }
 if (frames.quiz_main.currPage==56) {
   if (valid[56]==0) {
     ...
     StoreAnswer(56);    }
   frames.quiz_main.location.href="mcqdoc2Q58.htm" }
 if (frames.quiz_main.currPage==57) {
   if (valid[57]==0) {
     ...
     StoreAnswer(57);    }
   frames.quiz_main.location.href="mcqdoc2Q59.htm" }
 if (frames.quiz_main.currPage==58) {
   if (valid[58]==0) {
     ...
     StoreAnswer(58);    }
   frames.quiz_main.location.href="mcqdoc2Q60.htm" }
 if (frames.quiz_main.currPage==59) {
   if (valid[59]==0) {
     ...
     StoreAnswer(59);    }
   frames.quiz_main.location.href="mcqdoc2Q61.htm" }
 if (frames.quiz_main.currPage==60) {
   if (valid[60]==0) {
     ...
     StoreAnswer(60);    }
   frames.quiz_main.location.href="mcqdoc2Q62.htm" }
 if (frames.quiz_main.currPage==61) {
   if (valid[61]==0) {
     ...
     StoreAnswer(61);    }
   frames.quiz_main.location.href="mcqdoc2Q63.htm" }
 if (frames.quiz_main.currPage==62) {
   if (valid[62]==0) {
     ...
     StoreAnswer(62);    }
   frames.quiz_main.location.href="mcqdoc2Q64.htm" }
 if (frames.quiz_main.currPage==63) {
   if (valid[63]==0) {
     ...
     StoreAnswer(63);    }
   frames.quiz_main.location.href="mcqdoc2Q65.htm" }
 if (frames.quiz_main.currPage==64) {
   if (valid[64]==0) {
     ...
     StoreAnswer(64);    }
   frames.quiz_main.location.href="mcqdoc2Q66.htm" }
 if (frames.quiz_main.currPage==65) {
   if (valid[65]==0) {
     ...
     StoreAnswer(65);    }
   frames.quiz_main.location.href="mcqdoc2Q67.htm" }
 if (frames.quiz_main.currPage==66) {
   if (valid[66]==0) {
     ...
     StoreAnswer(66);    }
   frames.quiz_main.location.href="mcqdoc2Q68.htm" }
 if (frames.quiz_main.currPage==67) {
   if (valid[67]==0) {
     ...
     StoreAnswer(67);    }
   frames.quiz_main.location.href="mcqdoc2Q69.htm" }
 if (frames.quiz_main.currPage==68) {
   if (valid[68]==0) {
     ...
     StoreAnswer(68);    }
   frames.quiz_main.location.href="mcqdoc2Q70.htm" }
 if (frames.quiz_main.currPage==69) {
   if (valid[69]==0) {
     ...
     StoreAnswer(69);    }
   frames.quiz_main.location.href="mcqdoc2Q71.htm" }
 if (frames.quiz_main.currPage==70) {
   if (valid[70]==0) {
     ...
     StoreAnswer(70);    }
   frames.quiz_main.location.href="mcqdoc2Q72.htm" }
 if (frames.quiz_main.currPage==71) {
   if (valid[71]==0) {
     ...
     StoreAnswer(71);    }
   frames.quiz_main.location.href="mcqdoc2Q73.htm" }
 if (frames.quiz_main.currPage==72) {
   if (valid[72]==0) {
     ...
     StoreAnswer(72);    }
   frames.quiz_main.location.href="mcqdoc2Q74.htm" }
 if (frames.quiz_main.currPage==73) {
   if (valid[73]==0) {
     ...
     StoreAnswer(73);    }
   frames.quiz_main.location.href="mcqdoc2Q75.htm" }
 if (frames.quiz_main.currPage==74) {
   if (valid[74]==0) {
     ...
     StoreAnswer(74);    }
   frames.quiz_main.location.href="mcqdoc2Q76.htm" }
 if (frames.quiz_main.currPage==75) {
   if (valid[75]==0) {
     ...
     StoreAnswer(75);    }
   frames.quiz_main.location.href="mcqdoc2Q77.htm" }
 if (frames.quiz_main.currPage==76) {
   if (valid[76]==0) {
     ...
     StoreAnswer(76);    }
   frames.quiz_main.location.href="mcqdoc2Q78.htm" }
 if (frames.quiz_main.currPage==77) {
   if (valid[77]==0) {
     ...
     StoreAnswer(77);    }
   frames.quiz_main.location.href="mcqdoc2Q79.htm" }
 if (frames.quiz_main.currPage==78) {
   if (valid[78]==0) {
     ...
     StoreAnswer(78);    }
   frames.quiz_main.location.href="mcqdoc2Q80.htm" }
 if (frames.quiz_main.currPage==79) {
   if (valid[79]==0) {
     ...
     StoreAnswer(79);    }
   frames.quiz_main.location.href="mcqdoc2Q81.htm" }
 if (frames.quiz_main.currPage==80) {
   if (valid[80]==0) {
     ...
     StoreAnswer(80);    }
   frames.quiz_main.location.href="mcqdoc2Q82.htm" }
 if (frames.quiz_main.currPage==81) {
   if (valid[81]==0) {
     ...
     StoreAnswer(81);    }
   frames.quiz_main.location.href="mcqdoc2Q83.htm" }
 if (frames.quiz_main.currPage==82) {
   if (valid[82]==0) {
     ...
     StoreAnswer(82);    }
   frames.quiz_main.location.href="mcqdoc2Q84.htm" }
 if (frames.quiz_main.currPage==83) {
   if (valid[83]==0) {
     ...
     StoreAnswer(83);    }
   frames.quiz_main.location.href="mcqdoc2Q85.htm" }
 if (frames.quiz_main.currPage==84) {
   if (valid[84]==0) {
     ...
     StoreAnswer(84);    }
   frames.quiz_main.location.href="mcqdoc2Q86.htm" }
 if (frames.quiz_main.currPage==85) {
   if (valid[85]==0) {
     ...
     StoreAnswer(85);    }
   frames.quiz_main.location.href="mcqdoc2Q87.htm" }
 if (frames.quiz_main.currPage==86) {
   if (valid[86]==0) {
     ...
     StoreAnswer(86);    }
   frames.quiz_main.location.href="mcqdoc2Q88.htm" }
 if (frames.quiz_main.currPage==87) {
   if (valid[87]==0) {
     ...
     StoreAnswer(87);    }
   frames.quiz_main.location.href="mcqdoc2Q89.htm" }
 if (frames.quiz_main.currPage==88) {
   if (valid[88]==0) {
     ...
     StoreAnswer(88);    }
   frames.quiz_main.location.href="mcqdoc2Q90.htm" }
 if (frames.quiz_main.currPage==89) {
   if (valid[89]==0) {
     ...
     StoreAnswer(89);    }
   frames.quiz_main.location.href="mcqdoc2Q91.htm" }
 if (frames.quiz_main.currPage==90) {
   if (valid[90]==0) {
     ...
     StoreAnswer(90);    }
   frames.quiz_main.location.href="mcqdoc2Q92.htm" }
 if (frames.quiz_main.currPage==91) {
   if (valid[91]==0) {
     ...
     StoreAnswer(91);    }
   frames.quiz_main.location.href="mcqdoc2Q93.htm" }
 if (frames.quiz_main.currPage==92) {
   if (valid[92]==0) {
     ...
     StoreAnswer(92);    }
   frames.quiz_main.location.href="mcqdoc2Q94.htm" }
 if (frames.quiz_main.currPage==93) {
   if (valid[93]==0) {
     ...
     StoreAnswer(93);    }
   frames.quiz_main.location.href="mcqdoc2Q95.htm" }
 if (frames.quiz_main.currPage==94) {
   if (valid[94]==0) {
     ...
     StoreAnswer(94);    }
   frames.quiz_main.location.href="mcqdoc2Q96.htm" }
 if (frames.quiz_main.currPage==95) {
   if (valid[95]==0) {
     ...
     StoreAnswer(95);    }
   frames.quiz_main.location.href="mcqdoc2Q97.htm" }
 if (frames.quiz_main.currPage==96) {
   if (valid[96]==0) {
     ...
     StoreAnswer(96);    }
   frames.quiz_main.location.href="mcqdoc2Q98.htm" }
 if (frames.quiz_main.currPage==97) {
   if (valid[97]==0) {
     ...
     StoreAnswer(97);    }
   frames.quiz_main.location.href="mcqdoc2Q99.htm" }
 if (frames.quiz_main.currPage==98) {
   if (valid[98]==0) {
     ...
     StoreAnswer(98);    }
   frames.quiz_main.location.href="mcqdoc2Q100.htm" }
...
function initShortQuestion() {
 qstHead[0]="Incorrect statement regarding weakness is";
 qstHead[1]="Cause for sudden onset limitation of motion of a joint is due to";
 qstHead[2]="Diffuse swelling around a joint may be caused by all except";
 qstHead[3]="The 28-joint count during musculoskeletal examination includes all of the j...";
 qstHead[4]="Micrognathia may develop in";
 qstHead[5]="Hoarseness or a sense of fullness or discomfort in the throat, which is wor...";
 qstHead[6]="Only true points of articulation of the shoulder girdle with the trunk is d...";
 qstHead[7]="In medial epicondylitis, discomfort can be elicited by";
 qstHead[8]="The only carpometacarpal joint that moves to a notable degree is";
 qstHead[9]="The test which is useful in differentiating synovitis of the proximal inter...";
 qstHead[10]="Incorrect about lunate dislocation is";
 qstHead[11]="Causes for nodules on the hands joints are all except";
 qstHead[12]="Hip adduction is accomplished by all except";
 qstHead[13]="Earliest muscle atrophy usually develops in chronic arthritis of the knee is";
 qstHead[14]="Incorrect statement about Patellofemoral malalignment is";
 qstHead[15]="Patellar stability is assessed by the Fairbanks apprehension test which is ...";
 qstHead[16]="Plica syndrome, incorrect is";
 qstHead[17]="The normal knee range of motion full flexion is";
 qstHead[18]="Lateral ligaments of the foot consist of three distinct bands forming all e...";
 qstHead[19]="All of these tendons crossing ankle lie in anterior aspect except";
 qstHead[20]="Local monoarticular tenderness without swelling may be due to all except";
 qstHead[21]="Organism can be involved in Plant Thorn Synovitis is";
 qstHead[22]="Viral infections that can present as monoarthritis are all except";
 qstHead[23]="Freiberg disease is osteonecrosis of";
 qstHead[24]="Causes of osteonecrosis of bone are all except";
 qstHead[25]="Acute hemarthrosis suggests all of them except";
 qstHead[26]="Arthritis in Whipple?s disease, incorrect is";
 qstHead[27]="Systemic adult-onset JIA is characterized by all except";
 qstHead[28]="True about hemochromatosis is";
 qstHead[29]="Degenerative arthritis with discoloration of ear cartilage and sclera is se...";
 qstHead[30]="About Lipoma arborescens the following statement is not true";
 qstHead[31]="Incorrect statement about Complex regional pain syndrome type I is";
 qstHead[32]="The presence of Chondrocalcinosis on X Ray is more suggestive of";
 qstHead[33]="Fluorescence optical imaging (Rheumascan) true is";
 qstHead[34]="Most common of the characteristic mucocutaneous lesions of reactive arthrit...";
 qstHead[35]="The most common cutaneous manifestations of RA is";
 qstHead[36]="Bywaters lesions seen in RA. The incorrect statement is";
 qstHead[37]="Palisaded neutrophilic and granulomatous dermatitis (PNGD) of connective ti...";
 qstHead[38]="High risk for significant systemic disease in SLE is with";
 qstHead[39]="Subacute cutaneous lupus erythematosus is associated with antibodies to";
 qstHead[40]="The most common of the persistent lupus specific skin lesions is";
 qstHead[41]="Lupus panniculitis (LEP) lesions incorrect statement is";
 qstHead[42]="The first line systemic medication for cutaneous lupus is";
 qstHead[43]="Livedo reticularis is due to";
 qstHead[44]="Livedo reticularis can occur in all of the below except";
 qstHead[45]="Lupus nonspecific skin lesions are all of them except";
 qstHead[46]="Neonatal lupus erythematosus (NLE) which is associated with maternal IgG au...";
 qstHead[47]="Sj?gren?s syndrome patients can have all of them as a part of sjogren's sym...";
 qstHead[48]="The most common cutaneous manifestations of active dermatomyositis is";
 qstHead[49]="Patients with dermatomyositis are more likely to have interstitial lung dis...";
 qstHead[50]="Drug associated with skin changes mimicking dermatomyositis is";
 qstHead[51]="Parry Romberg syndrome is";
 qstHead[52]="Linear scleroderma";
 qstHead[53]="Regarding Eosinophilic fasciitis (EF) which of the following is incorrect";
 qstHead[54]="POEMS syndrome need not include";
 qstHead[55]="Scleromyxedema frequently characterized by dysproteinemia and all of them e...";
 qstHead[56]="Hypersensitivity vasculitis, the incorrect is";
 qstHead[57]="The typical and most common initial lesion of IgA predominant small vessel ...";
 qstHead[58]="IgA predominant vasculitis which of the following is not true";
 qstHead[59]="Hypocomplementemic urticarial vasculitis syndrome is characterised by all e...";
 qstHead[60]="Most common form of panniculitis is";
 qstHead[61]="Papular purpuric gloves and socks syndrome occurs due to";
 qstHead[62]="Weber Christian disease are now recognized to be separate entities like all...";
 qstHead[63]="Erysipelas like erythema (ELE) is the pathognomonic skin manifestation of";
 qstHead[64]="Multicentric reticulohistiocytosis can have all of the following except";
 qstHead[65]="Eye lesion unlikely to occur in relapsing polychondritis is";
 qstHead[66]="Proteoglycan present both in the eye and in joints is";
 qstHead[67]="Blau Syndrome, which is incorrect";
 qstHead[68]="Which of the following is not true about anterior uveitis associated with h...";
 qstHead[69]="Immune mediated diseases most often associated with uveitis are all except";
 qstHead[70]="Second most common systemic disease associated with uveitis after Ankylosin...";
 qstHead[71]="Regarding eye involvement is behcet's disease the incorrect is";
 qstHead[72]="The immune mediated disease that most commonly affects the optic nerve is";
 qstHead[73]="Medications which can cause uveitis are all except";
 qstHead[74]="Tests should be used to monitor for antimalarial ocular toxicity are all of...";
 qstHead[75]="The following cervical vertebra has no vertebral body";
 qstHead[76]="Cervicogenic headaches are thought to result from irritation of the";
 qstHead[77]="Most common organism to cause pediatric discitis is";
 qstHead[78]="Involvement of Cervical Nerve Root C6 can cause all of the following except";
 qstHead[79]="Pseudoangina pectoris is due to the result of lesion of";
 qstHead[80]="Parsonage Turner syndrome, incorrect is";
 qstHead[81]="False about anatomic landmark of cervical vertebra are all except";
 qstHead[82]="Which is the earliest and most impaired movement in degenerative diseases";
 qstHead[83]="Which is the earliest and most impaired movement in Rheumatoid arthritis";
 qstHead[84]="The most mobile joint of the body is";
 qstHead[85]="These miscellaneous diseases are the causes of shoulder pain by one or the ...";
 qstHead[86]="Pain in impingement with rotator cuff tendinopathy is";
 qstHead[87]="Clancy test for diagnosing rotator cuff tendinopathy is";
 qstHead[88]="Speed?s test is performed for";
 qstHead[89]="Nontraumatic painful shoulder imaging evaluation positioning includes all e...";
 qstHead[90]="Rotator cuff tears can be best diagnosed by";
 qstHead[91]="The most common inflammatory arthritis involving the shoulder joint is";
 qstHead[92]="Treatment of choice for end stage bony erosion of shoulder joint and soft t...";
 qstHead[93]="Osteoarthritis of the glenohumeral joint is most common in";
 qstHead[94]="The most common cause of osteonecrosis of the shoulder is due to";
 qstHead[95]="Friedrich?s syndrome is painful osteonecrosis of";
 qstHead[96]="RSD (Reflex sympathetic dystrophy) is divided into three phases";
 qstHead[97]="Most common cause of Low back pain (LBP) worldwide is due the";
 qstHead[98]="The following one is against the classical features of spondyloarthritis";
 qstHead[99]="Incorrect about Sacroiliac joints is";
}
